...
public final class DBConnection {
    ...
    public DBConnection(String motdepasse) {
     ...
     * @return true si la connetion s'ouvre bien sinon false
     */
 ...
 * @param co variable de la connection comprenant un url un login et un mot de passe
 * @return true si la connetion s'ouvre bien sinon false
 */
 ...
 * @return true si la connection se ferme bien sinon false
 */
 ...
 * @param login login du joueur
 * @throws SQLException si la modification de la base de données ne s'effectue pas faire une exception
 */
